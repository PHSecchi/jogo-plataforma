...
Level1::Level1(string tilePath, string mapPath, string bgPath, sf::Vector2f point, float* t, sf::RenderWindow* window):
	Level(tilePath, mapPath, bgPath, point, t, window, 1)
{
}
...
void Level1::setPlayerPosition()
{
	player->restart();
	player->setPosition(sf::Vector2f(3.5 * 96.f, 27 * 96.f));
}

const sf::Vector2f Level1::getEndPoint() const
{
	return endPoint;
}
...
void Level1::initTiles(string tilePath)
{
...
void Level1::retrieveEntities()
{
	...
	{
		cout << "Unable to open \"saves/Goblin.txt\" in \"Level1.cpp\"" << endl;
		exit(1);
	}
	...
	{
		cout << "Unable to open \"saves/BomberGoblin.txt\" in \"Level1.cpp\"" << endl;
		exit(1);
	}
	...
	{
		cout << "Unable to open \"saves/Bomb.txt\" in \"Level1.cpp\"" << endl;
		exit(1);
	}
}